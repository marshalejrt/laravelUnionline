            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <ul class="menu-collapse collapse" id="ui_menu_Monitores">
                        <li>
                            <a class="waves-attach" href="javascript:void(0)">Mis Asignaturas</a>
                        </li>
                        <li>
                            <a class="waves-attach" href="javascript:void(0)">Monitorear<small class="margin-left-xs">(Responder Preguntas)</small></a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="menu-collapse collapse" id="ui_menu_reportes">
                        <li>
                            <a class="waves-attach" href="javascript:void(0)">Mejores Estudiantes</a>
                        </li>
                    </ul>
                </li>
            </ul>
